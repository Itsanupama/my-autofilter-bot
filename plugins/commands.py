...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ ʙᴏᴛ ᴜᴘᴅᴀᴛᴇs ⚡', url='http://t.me/Anu_updates_bot')
            ],
            [
                InlineKeyboardButton('✨ʙᴀᴄᴋᴜᴘ ᴄʜᴀɴɴᴇʟ✨', url=f"https://t.me/+xnS39gpvXdwwNmQx"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('✨ʙᴀᴄᴋᴜᴘ ᴄʜᴀɴɴᴇʟ ✨', url='https://t.me/+xnS39gpvXdwwNmQx'),
            InlineKeyboardButton('🤖 ʙᴏᴛ ᴜᴘᴅᴀᴛᴇs 🤖', url='http://t.me/Anu_updates_bot')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('ᴍᴏᴠɪᴇ ʀᴇǫᴜᴇsᴛ ɢʀᴏᴜᴘ', url='https://t.me/+2DfH1RvI0d9jYThl') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('𝙿𝙻𝙴𝙰𝚂𝙴 𝚂𝙷𝙰𝚁𝙴 𝙰𝙽𝙳 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 @Movies_Telugu_Top')
